import { getFeaturedProjects } from "../data/projects.js?v=cf5e129c45";
import { contacts } from "../data/contacts.js?v=cf5e129c45";
import { resumeItems } from "../data/resume.js?v=cf5e129c45";
import { stackItems } from "../data/stack.js?v=cf5e129c45";
import { contactLink } from "../components/contactLink.js?v=cf5e129c45";
import { iconBriefcase } from "../components/icons.js?v=cf5e129c45";
import { projectCard } from "../components/projectCard.js?v=cf5e129c45";
import { stackCard } from "../components/stackCard.js?v=cf5e129c45";
    ...
    return `
            ...
            <section class="rounded-2xl border border-white/10 bg-white/[0.03] p-4 shadow-2xl shadow-black/40">
                <div class="overflow-hidden rounded-xl border border-white/10 bg-zinc-950">
                    ...
                    <div class="space-y-4 p-6 font-mono text-sm">
                        ...
                        <p><span class="text-sky-400">Output:</span> listo para seguir aprendiendo.</p>
                    </div>
                </div>
            </section>
        </header>
        ...
        <section id="cv" class="mx-auto max-w-6xl px-6 py-20">
            <div class="mb-12 flex items-center gap-4">
                ...
                <div>
                    <p class="mb-1 text-sm font-bold uppercase tracking-[0.25em] text-sky-400">Curr&iacute;culum</p>
        ...
        <section id="proyectos-destacados" class="mx-auto max-w-6xl px-6 py-20">
            <div class="mb-12 flex flex-col justify-between gap-4 md:flex-row md:items-end">
                <div>
                    <p class="mb-2 text-sm font-bold uppercase tracking-[0.25em] text-sky-400">Proyectos destacados</p>
        ...
        <section id="stack" class="border-y border-white/10 bg-white/[0.03]">
            <div class="mx-auto max-w-6xl px-6 py-20">
                <p class="mb-2 text-sm font-bold uppercase tracking-[0.25em] text-sky-400">Stack</p>
        ...
        <section id="contacto" class="mx-auto max-w-6xl px-6 py-20">
            <div class="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                <div>
                    <p class="mb-2 text-sm font-bold uppercase tracking-[0.25em] text-sky-400">Contacto</p>
